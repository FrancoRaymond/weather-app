...
const Loader = () => {
  ...
  return (
    <div className="px-2.5 sm:px-5 md:px-10 lg:px-24 mt-10 flex flex-col md:flex-row gap-6">
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-5 gap-6 w-full md:w-[65%]">
            <div className="grid-cols-1 row-span-1 md:row-span-3 md:col-span-4 gap-4 ">
                <div className="grid md:grid-cols-4 md:grid-row-3 gap-5 md:h-full">
                    <div className="bg-[#29253f] p-10 w-full rounded-md col-span-1 row-span-1 md:col-span-4 md:row-span-2"></div>
            ...
            <div className="md:col-span-4 md:row-span-2 flex flex-col gap-2 p-2 w-full">
                ...
                <div className="grid lg:grid-cols-7 gap-5 mt-4">
        ...
        <div className="bg-[#29253f] p-3 rounded-md w-full md:w-[30%] flex flex-col gap-4">
